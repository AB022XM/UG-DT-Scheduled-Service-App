package ug.co.absa.validation.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.validation.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.validation.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.validation.service.InvalidPasswordException
